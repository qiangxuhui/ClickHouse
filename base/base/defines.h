...
#if !defined(__x86_64__) && !defined(__aarch64__) && !defined(__PPC__) && !defined(__s390x__) && !(defined(__riscv) && (__riscv_xlen == 64)) && !(defined(__loongarch64))
#    error "The only supported platforms are x86_64 and AArch64, PowerPC (work in progress), s390x (work in progress), RISC-V 64 (experimental) and Loongarch64 (experimental)"
#endif
